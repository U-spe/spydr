...
(function (SuperSoccerNoggins) {
    var GameManager = (function () {
        ...
        GameManager.prototype.init = function (game) {
            if (!SuperSoccerNoggins.GameVars.areValidDomains(["unblocked-games", "localhost", "freezenova.com", "127"])) {
                return;
            }
            this.game = game;
...
(function (SuperSoccerNoggins) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.loadAssets = function () {
            ...
            this.load.image("logo", "assets/freezenovagames.png");
...
(function (SuperSoccerNoggins) {
    var SplashState = (function (_super) {
        ...
        SplashState.prototype.create = function () {
            ...
            var playButton = this.add.button(82, SuperSoccerNoggins.GameVars.getInstance().christmasVersion ? 278 : 258, "texture_atlas_1", this.onClickPlay, this);
            playButton.setFrames("button_play_on.png", "button_play_off.png", "button_play_on.png");
            playButton.anchor.set(.5);
            this.pvpButton = this.add.sprite(216, SuperSoccerNoggins.GameVars.getInstance().christmasVersion ? 278 : 258, "texture_atlas_1");
            ...
            var logo = this.add.image(SuperSoccerNoggins.GameConstants.GAME_WIDTH - 5, SuperSoccerNoggins.GameConstants.GAME_HEIGHT - 5, "logo");
            logo.scale.set(.35);
            logo.anchor.set(1);
            SuperSoccerNoggins.AudioManager.getInstance().playLoop("noggins_menu");
            if (SuperSoccerNoggins.GameVars.getInstance().christmasVersion) {

...
function SoundMixer() {
	...
	const TRACKS_URLS = {
		...
		AndrewOdd_Elysium: MUSIC_URL + "AndrewOdd-Elysium.ogg",
		KylePreston_BrknPhoto: MUSIC_URL + "KylePreston-BrokenPhotosynthesis.ogg",
		SimonBainton_Hurtstone: MUSIC_URL + "SimonBainton-Hurtstone.ogg",
		SimonBainton_Porlock: MUSIC_URL + "SimonBainton-Porlock.ogg",
		SimonBainton_Tankah: MUSIC_URL + "SimonBainton-Tankah.ogg",
		StromNoir_Hollow: MUSIC_URL + "StromNoir-Hollow.ogg",
		StromNoir_WinterDay: MUSIC_URL + "StromNoir-SuchaBeautifulWinterDay.ogg",
		StromNoir_Spring: MUSIC_URL + "StromNoir-Thebeginningofspring.ogg",
		TobiasHellkvist_HearYou: MUSIC_URL + "TobiasHellkvist-WhereNoOneCanHearYou.ogg"
	};

...
(function (BasketChamps) {
    var AchievementsManager = (function () {
        ...
        AchievementsManager.prototype.matchStart = function () {
        };
        AchievementsManager.prototype.matchEnded = function () {
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.POKI) {
...
(function (BasketChamps) {
    var GameConstants = (function () {
        ...
        GameConstants.ADDICTING_GAMES = "addictinggames.com";
        GameConstants.POKI = "poki";
        GameConstants.TUNNL = "tunnl";
        GameConstants.YANDEX = "Yandex";
        GameConstants.GAMEZOP = "gamezop";
        GameConstants.MOBILE8 = "mobile8";
        GameConstants.GAMEDISTRIBUTION = "game distribution";
        GameConstants.PLAYS = "plays.org";
        GameConstants.NONE = "sponsor";
        GameConstants.SPONSOR = GameConstants.NONE;
        GameConstants.LINK_MINIJUEGOS = "http://www.minijuegos.com/helpers/game/findAndPlay.php?game=basket-champs";
        GameConstants.LINK_MINIJUEGOS_MORE_BASKET_GAMES = "http://mnj.gs/basket";
        GameConstants.LINK_ADDICTINGGAMES = "http://www.addictinggames.com";
...
window.onload = function () {
    if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
        if (isDomainValid) {
    ...
    var MatchController = (function () {
        function MatchController(game) {
            ...
            if (this.game.device.desktop) {
                ...
                if (BasketChamps.GameConstants.SPONSOR !== BasketChamps.GameConstants.YANDEX) {
...
(function (BasketChamps) {
    var Boot = (function (_super) {
        ...
        Boot.onYandexFullscreenChanged = function () {
            if (BasketChamps.Game.currentInstance.device.desktop) {
                var aspectRatio = BasketChamps.GameConstants.GAME_WIDTH / BasketChamps.GameConstants.GAME_HEIGHT;
                var widthLimit = window.innerWidth;
                if ((widthLimit / aspectRatio) > window.innerHeight) {
                    widthLimit = window.innerHeight * aspectRatio;
                }
                var heightLimit = widthLimit / aspectRatio;
                BasketChamps.Game.currentInstance.scale.maxWidth = widthLimit;
                BasketChamps.Game.currentInstance.scale.maxHeight = heightLimit;
                BasketChamps.Game.currentInstance.scale.minWidth = BasketChamps.Game.currentInstance.scale.maxWidth;
                BasketChamps.Game.currentInstance.scale.minHeight = BasketChamps.Game.currentInstance.scale.maxHeight;
            }
            else {
                if (BasketChamps.Game.currentInstance.device.iOS) {
                    BasketChamps.Game.currentInstance.time.events.add(200, function () {
                        var widthLimit = window.innerWidth;
                        var heightLimit = window.innerHeight;
                        BasketChamps.Game.currentInstance.scale.minWidth = widthLimit;
                        BasketChamps.Game.currentInstance.scale.maxWidth = widthLimit;
                        BasketChamps.Game.currentInstance.scale.minHeight = heightLimit;
                        BasketChamps.Game.currentInstance.scale.maxHeight = heightLimit;
                        BasketChamps.Game.currentInstance.scale.refresh();
                        return;
                    }, this);
                }
                else {
                    BasketChamps.Game.currentInstance.scale.minWidth = window.innerWidth;
                    BasketChamps.Game.currentInstance.scale.maxWidth = window.innerWidth;
                    BasketChamps.Game.currentInstance.scale.minHeight = window.innerHeight;
                    BasketChamps.Game.currentInstance.scale.maxHeight = window.innerHeight;
                }
            }
            BasketChamps.Game.currentInstance.scale.refresh();
        };
        ...
        Boot.prototype.create = function () {
            ...
            if (BasketChamps.GameVars.areValidDomains(["unblocked-games", "onlinegames", "totallyscience", "freezenova.com", "localhost", "127"])) {
        ...
        Boot.prototype.leaveIncorrectOrientation = function () {
            ...
            if (Boot.bootedInWrongOrientation) {
                ...
                this.game.time.events.add(250, function () {
                    ...
                    if (BasketChamps.PreLoader.currentInstance) {
                        this.game.state.start("PreLoader", true, false);
                    }
                    else {
...
(function (BasketChamps) {
    var ConfirmationMenu = (function (_super) {
        ...
        function ConfirmationMenu(game, pauseMenu) {
            ...
            var label = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2, 210, "YOUR PROGRESS WILL BE LOST", { font: "34px Jomhuria" });
            label.addColor("#4D3E44", 0);
            label.anchor.set(.5);
            _this.add(label);
            label = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2, 232, "CONFIRM?", { font: "24px Jomhuria" });
            label.addColor("#4D3E44", 0);
            label.anchor.set(.5);
            _this.add(label);
            ...
            label = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2, 306, "RESET", { font: "24px Jomhuria" });
            label.addColor("#4D3E44", 0);
            label.anchor.set(.5);
            _this.add(label);
...
(function (BasketChamps) {
    var GameOverLayer = (function (_super) {
        ...
        function GameOverLayer(game) {
            ...
            _this.visible = false;
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.MINIJUEGOS) {
                var moreGamesButtons = new BasketChamps.MinijuegosMoreGamesButton(_this.game, 60, 315);
...
(function (BasketChamps) {
    var MatchManager = (function () {
        function MatchManager() {
            ...
            this.rebounds = 0;
            BasketChamps.AchievementsManager.getInstance().matchStart();
        }
...
(function (BasketChamps) {
    var PauseLayer = (function (_super) {
        ...
        function PauseLayer(game) {
            ...
            var textNew1 = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 + 10, 250 - 10, "RESET", { font: "30px Jomhuria" });
            textNew1.addColor("#ffffff", 0);
            textNew1.anchor.set(0, .5);
            _this.buttonsContainer.add(textNew1);
            var textNew2 = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 + 10, 250 + 10, "TOURNAMENT", { font: "30px Jomhuria" });
            ...
            var textExit = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 + 10, 310, "EXIT", { font: "30px Jomhuria" });
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                var sponsorLogo = new Phaser.Button(_this.game, 15, 280, "texture_atlas_1", _this.onLogoClicked, _this);
                sponsorLogo.setFrames("button_addictinggames_logo_on.png", "button_addictinggames_logo_off.png", "button_addictinggames_logo_on.png");
                _this.add(sponsorLogo);
            }
            return _this;
        }
        ...
        PauseLayer.prototype.onLogoClicked = function () {
            var win;
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                win = window.open(BasketChamps.GameConstants.LINK_ADDICTINGGAMES, "_blank");
                win.focus();
            }
        };
    ...
    var BackgroundManager = (function (_super) {
        ...
        BackgroundManager.prototype.matchReady = function () {
            ...
            if (BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name2 === null) {
                this.teamPlayerName = new Phaser.Text(this.game, 165, 80, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name, { font: "20px Mirza" });
                this.teamPlayerName.addColor("#8FAABF", 0);
                this.teamPlayerName.anchor.set(.5);
                this.addChild(this.teamPlayerName);
            }
            else {
                this.teamPlayerName = new Phaser.Text(this.game, 165, 77, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name, { font: "20px Mirza" });
                this.teamPlayerName.addColor("#8FAABF", 0);
                this.teamPlayerName.anchor.set(.5);
                this.addChild(this.teamPlayerName);
                this.teamPlayerName2 = new Phaser.Text(this.game, 165, 92, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name2, { font: "20px Mirza" });
            ...
            if (BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name2 === null) {
                this.teamAIName = new Phaser.Text(this.game, 480, 80, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name, { font: "20px Mirza" });
                this.teamAIName.addColor("#8FAABF", 0);
                this.teamAIName.anchor.set(.5);
                this.addChild(this.teamAIName);
            }
            else {
                this.teamAIName = new Phaser.Text(this.game, 480, 77, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name, { font: "20px Mirza" });
                this.teamAIName.addColor("#8FAABF", 0);
                this.teamAIName.anchor.set(.5);
                this.addChild(this.teamAIName);
                this.teamAIName2 = new Phaser.Text(this.game, 480, 92, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name2, { font: "20px Mirza" });
...
(function (BasketChamps) {
    var ClassificationLayer = (function (_super) {
        ...
        function ClassificationLayer(game) {
            ...
            _this.teamLabel = new Phaser.Text(_this.game, 80 - _this.x, 75 - _this.y, "TEAM", { font: "25px Jomhuria" });
            _this.teamLabel.anchor.set(.5);
            _this.teamLabel.addColor("#6f9da8", 0);
            _this.add(_this.teamLabel);
            _this.wonLabel = new Phaser.Text(_this.game, 197 - _this.x, 75 - _this.y, "WON", { font: "25px Jomhuria" });
            _this.wonLabel.anchor.set(.5);
            _this.wonLabel.addColor("#6f9da8", 0);
            _this.add(_this.wonLabel);
            _this.lostLabel = new Phaser.Text(_this.game, 322 - _this.x, 75 - _this.y, "LOST", { font: "25px Jomhuria" });
            _this.lostLabel.anchor.set(.5);
            _this.lostLabel.addColor("#6f9da8", 0);
            _this.add(_this.lostLabel);
            _this.pointsLabel = new Phaser.Text(_this.game, 444 - _this.x, 75 - _this.y, "POINTS", { font: "25px Jomhuria" });
        ...
        ClassificationLayer.prototype.setGroup = function () {
            ...
            this.group = new Phaser.Text(this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 - 10 - this.x, 38 - this.y, nameGroup, { font: "35px Jomhuria" });
    ...
    var ClassificationTeam = (function (_super) {
        ...
        function ClassificationTeam(game, teamId, b, x, y, pos) {
            ...
            if (_this.id === BasketChamps.GameVars.getInstance().myTeamID) {
                ...
                _this.wonLabel = new Phaser.Text(_this.game, 197, 3, BasketChamps.GameVars.getInstance().groupWins[teamId].toString(), { font: "50px Jomhuria" });
                _this.wonLabel.addColor("#15212a", 0);
                _this.lostLabel = new Phaser.Text(_this.game, 322, 3, BasketChamps.GameVars.getInstance().groupLoses[teamId].toString(), { font: "50px Jomhuria" });
                _this.lostLabel.addColor("#15212a", 0);
                _this.pointsLabel = new Phaser.Text(_this.game, 444, 3, (BasketChamps.GameVars.getInstance().groupWins[teamId] * 2 + BasketChamps.GameVars.getInstance().groupLoses[teamId]).toString(), { font: "50px Jomhuria" });
                _this.pointsLabel.addColor("#15212a", 0);
            }
            else {
                _this.flag.scale.set(.5);
                _this.flag.alpha = .7;
                _this.wonLabel = new Phaser.Text(_this.game, 197, 3, BasketChamps.GameVars.getInstance().groupWins[teamId].toString(), { font: "40px Jomhuria" });
                _this.wonLabel.addColor("#557a8b", 0);
                _this.lostLabel = new Phaser.Text(_this.game, 322, 3, BasketChamps.GameVars.getInstance().groupLoses[teamId].toString(), { font: "40px Jomhuria" });
                _this.lostLabel.addColor("#557a8b", 0);
                _this.pointsLabel = new Phaser.Text(_this.game, 444, 3, (BasketChamps.GameVars.getInstance().groupWins[teamId] * 2 + BasketChamps.GameVars.getInstance().groupLoses[teamId]).toString(), { font: "40px Jomhuria" });
...
(function (BasketChamps) {
    var FinishMatch = (function (_super) {
        ...
        function FinishMatch(game) {
            ...
            FinishMatch.currentInstance = _this;
        ...
        FinishMatch.prototype.onNextClicked = function () {
            ...
            (_a = this.pulseTween) === null || _a === void 0 ? void 0 : _a.stop();
    ...
    var TeamNamesContainer = (function (_super) {
        ...
        function TeamNamesContainer(game) {
            ...
            if (BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name2 === undefined) {
                _this.teamPlayerName = new Phaser.Text(_this.game, 140, 334, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name, { font: "50px Jomhuria" });
                ...
                _this.teamPlayerName = new Phaser.Text(_this.game, 140, 318, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name, { font: "50px Jomhuria" });
                _this.teamPlayerName.addColor("#079e10", 0);
                _this.teamPlayerName.anchor.set(.5);
                _this.teamPlayerName.alpha = 0;
                _this.addChild(_this.teamPlayerName);
                _this.teamPlayerName2 = new Phaser.Text(_this.game, 140, 347, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().myTeamID - 1].name2, { font: "50px Jomhuria" });
            ...
            if (BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name2 === undefined) {
                _this.teamAIName = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH - 105, 334, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name, { font: "50px Jomhuria" });
                ...
                _this.teamAIName = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH - 105, 318, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name, { font: "50px Jomhuria" });
                _this.teamAIName.addColor("#ff053a", 0);
                _this.teamAIName.anchor.set(.5);
                _this.teamAIName.alpha = 0;
                _this.addChild(_this.teamAIName);
                _this.teamAIName2 = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH - 105, 347, BasketChamps.GameVars.getInstance().teamsData[BasketChamps.GameVars.getInstance().oponentPlayer()].name2, { font: "50px Jomhuria" });
...
(function (BasketChamps) {
    var SelectTeamLayer = (function (_super) {
        ...
        function SelectTeamLayer(game) {
            ...
            reusableBmd.ctx.fillStyle = "#ffffff";
            reusableBmd.ctx.fill();
            _this.groupTitle = new Phaser.Text(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 - 10, 38, "SELECT YOUR TEAM", { font: "35px Jomhuria" });
            _this.groupTitle.addColor("#ffffff", 0);
            _this.groupTitle.anchor.set(.5);
            _this.add(_this.groupTitle);
            _this.groupA = new Phaser.Text(_this.game, 90, 75, "GROUP A", { font: "25px Jomhuria" });
            _this.groupA.anchor.set(.5);
            _this.groupA.addColor("#6f9da8", 0);
            _this.add(_this.groupA);
            _this.groupB = new Phaser.Text(_this.game, 217, 75, "GROUP B", { font: "25px Jomhuria" });
            _this.groupB.anchor.set(.5);
            _this.groupB.addColor("#6f9da8", 0);
            _this.add(_this.groupB);
            _this.groupC = new Phaser.Text(_this.game, 342, 75, "GROUP C", { font: "25px Jomhuria" });
            _this.groupC.anchor.set(.5);
            _this.groupC.addColor("#6f9da8", 0);
            _this.add(_this.groupC);
            _this.groupD = new Phaser.Text(_this.game, 464, 75, "GROUP D", { font: "25px Jomhuria" });
    ...
    var TeamGroup = (function (_super) {
        ...
        function TeamGroup(game, teamId, x, y) {
            ...
            if (!BasketChamps.GameVars.getInstance().teamsData[teamId].name2) {
                _this.teamLabel = new Phaser.Text(_this.game, -5, 3, BasketChamps.GameVars.getInstance().teamsData[teamId].name, { font: "20px Jomhuria" });
                _this.teamLabel.addColor("#6f9da8", 0);
                _this.teamLabel.anchor.set(0, .5);
                _this.add(_this.teamLabel);
            }
            else {
                _this.teamLabel = new Phaser.Text(_this.game, -5, -4, BasketChamps.GameVars.getInstance().teamsData[teamId].name, { font: "20px Jomhuria" });
                _this.teamLabel.addColor("#6f9da8", 0);
                _this.teamLabel.anchor.set(0, .5);
                _this.add(_this.teamLabel);
                _this.teamLabel2 = new Phaser.Text(_this.game, -5, 10, BasketChamps.GameVars.getInstance().teamsData[teamId].name2, { font: "20px Jomhuria" });
...
(function (BasketChamps) {
    var TournamentLayer = (function (_super) {
        ...
        TournamentLayer.prototype.updateTournament = function () {
            ...
            if (BasketChamps.GameVars.getInstance().numMatch === 5) {
                this.group = new Phaser.Text(this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 - 10, 38, "TOURNAMENT - K.O. PHASE", { font: "35px Jomhuria" });
            }
            else if (BasketChamps.GameVars.getInstance().numMatch === 6) {
                this.group = new Phaser.Text(this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 - 10, 38, "TOURNAMENT - QUARTERFINALS", { font: "30px Jomhuria" });
            }
            else if (BasketChamps.GameVars.getInstance().numMatch === 7) {
                this.group = new Phaser.Text(this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 - 10, 38, "TOURNAMENT - SEMIFINALS", { font: "30px Jomhuria" });
            }
            else if (BasketChamps.GameVars.getInstance().numMatch === 8) {
                this.group = new Phaser.Text(this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 - 10, 38, "TOURNAMENT - FINAL", { font: "35px Jomhuria" });
            }
            this.group.addColor("#ffffff", 0);
            this.group.anchor.set(.5);
            this.add(this.group);
            ...
            this.vsText = new Phaser.Text(this.game, 280, 213, "VS", { font: "35px Jomhuria" });
...
(function (BasketChamps) {
    var CreditsState = (function (_super) {
        ...
        CreditsState.prototype.create = function () {
            ...
            var text;
            text = new Phaser.Text(this.game, 100, 40, "A GAME BY ", { font: "60px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            this.add.image(270, 43, "texture_atlas_1", "ravalmatic_horizontal.png");
            text = new Phaser.Text(this.game, 100, 90, "PROGRAMMER:  DAVID ESCRICHE ", { font: "40px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 120, "LEAD PROGRAMMER:  ENRIQUETO ", { font: "40px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            ...
            pulseTween.loop();
            pulseTween.start();
            text = new Phaser.Text(this.game, 100, 150, "ART & UX:  JAVI SANZ ", { font: "40px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 180, "FLAG DESIGN:  MUHARREM SENYIL ", { font: "40px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 210, "SOUND FX:  WILFORD MCPERTIGAN ", { font: "40px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 240, "SOUNDTRACK:  BOOMOPERA ", { font: "40px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 280, "PHYSICS ENGINE:  BOX2D ", { font: "30px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 300, "GAME FRAMEWORK:  PHASER ", { font: "30px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
            text = new Phaser.Text(this.game, 100, 320, "BASED ON:  WORLD BASKETBALL CHAMPIONSHIP ", { font: "30px Jomhuria", fill: "#152c32" });
            this.add.existing(text);
...
(function (BasketChamps) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.preload = function () {
            ...
            this.load.image("logo", "/sponsors/freezenovagames.png");
        ...
        PreLoader.prototype.starGame = function () {
        ...
        PreLoader.prototype.composeScene = function () {
            var t = this.add.text(0, 0, "abcdefg", { font: "20px Mirza" });
            t.alpha = 0;
            t = this.add.text(0, 0, "abcdefg", { font: "20px Jomhuria" });
            t.alpha = 0;
...
(function (BasketChamps) {
    var SplashController = (function () {
        function SplashController(game) {
            ...
            this.game = game;
            if (!this.game.device.desktop && BasketChamps.GameConstants.SPONSOR !== BasketChamps.GameConstants.GAMEPIX && BasketChamps.GameConstants.SPONSOR !== BasketChamps.GameConstants.YANDEX) {
                if (!this.game.scale.isFullScreen) {
                    this.game.input.onDown.add(this.goFull, this);
                }
            }
    ...
    var SplashState = (function (_super) {
        ...
        SplashState.prototype.create = function () {
            ...
            if (BasketChamps.GameVars.getInstance().myTeamID === 0) {
                ...
                var textNew1 = this.add.text(280, 342, "RESET", { font: "25px Jomhuria" });
                textNew1.addColor("#504048", 0);
                textNew1.anchor.set(0, .5);
                this.labelsContainer.add(textNew1);
                var textNew2 = this.add.text(280, 358, "TOURNAMENT", { font: "25px Jomhuria" });
            ...
            var copyRightLabel = this.add.text(18, BasketChamps.GameConstants.GAME_HEIGHT - 14, "made by RavalMatic", { font: "10px  Arial", fill: "#eeeeee" });
            copyRightLabel.alpha = .75;
            this.labelsContainer.add(copyRightLabel);
            var logo = this.add.image(BasketChamps.GameConstants.GAME_WIDTH - 4, BasketChamps.GameConstants.GAME_HEIGHT - 4, "logo");
            logo.scale.set(.35);
            logo.anchor.set(1);
        ...
        SplashState.prototype.onContinueClicked = function () {
            ...
            this.leavingScene = true;
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.GAMEDISTRIBUTION) {
...
var BasketChamps;
(function (BasketChamps) {
    var MinijuegosMoreGamesButton = (function (_super) {
        __extends(MinijuegosMoreGamesButton, _super);
        function MinijuegosMoreGamesButton(game, x, y) {
            var _this = _super.call(this, game, x, y, "texture_atlas_minijuegos") || this;
            _this.anchor.set(.5);
            _this.animations.add("spin", Phaser.Animation.generateFrameNames("btn_more_games", 13, 1, ".png", 4));
            _this.play("spin", 20, true);
            _this.inputEnabled = true;
            _this.input.pixelPerfectOver = true;
            _this.input.pixelPerfectClick = true;
            _this.events.onInputDown.add(_this.onClickBall, _this);
            _this.events.onInputOver.add(_this.onOverBall, _this);
            _this.events.onInputOut.add(_this.onOutBall, _this);
            return _this;
        }
        MinijuegosMoreGamesButton.prototype.onClickBall = function () {
            var win = window.open(BasketChamps.GameConstants.LINK_MINIJUEGOS_MORE_BASKET_GAMES, "_blank");
            win.focus();
        };
        MinijuegosMoreGamesButton.prototype.onOverBall = function () {
            this.scale.set(1.1);
        };
        MinijuegosMoreGamesButton.prototype.onOutBall = function () {
            this.scale.set(1);
        };
        return MinijuegosMoreGamesButton;
    }(Phaser.Sprite));
    BasketChamps.MinijuegosMoreGamesButton = MinijuegosMoreGamesButton;
})(BasketChamps || (BasketChamps = {}));
var Utils;
(function (Utils) {
...
//# sourceMappingURL=basket-champs.min.js.map
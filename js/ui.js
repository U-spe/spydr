...
export default class UIManager {
    ...
    syncFormControls() {
        this.dom.toggleAutosave.checked = this.settings.get('autoSave');
        this.dom.toggleStars.checked = this.settings.get('starsEnabled');
        this.dom.bgStyleSelect.value = this.settings.get('bgStyle');
        this.dom.toggleCloak.checked = this.settings.get('cloakEnabled');
        this.dom.cloakTargetSelect.value = this.settings.get('cloakTarget');

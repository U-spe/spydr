...
var playbackControl = {
  ...
  resume: function () {
    ...
    if (typeof ig !== "undefined") {
      if (ig.game) {
        if (typeof ig.game.getMusicVolume === "function") {
          var bgmVolume = ig.game.getMusicVolume();
          if (typeof ig.game.setMusicVolume === "function") 
            ig.game.setMusicVolume(bgmVolume);
        }
        if (typeof ig.game.getSoundVolume === "function") {
          var sfxVolume = ig.game.getSoundVolume();
          if (typeof ig.game.setSoundVolume === "function") 
            ig.game.setSoundVolume(sfxVolume);
        }
      }
    }

...
function REWARDED_ADS_COMPLETED(isSuccess) {
  //call rewarded ads success function, true => success/completed, false => incompleted
  if (isSuccess) {
    ig.game.adsController.onAdsSuccess();
  } else {
    ig.game.adsController.onAdsFail();
  }
}
...
var playbackControl = {
  ...
  unmuteAudio: function () {
    if (this.adsFlags.cachedSfxMutedFlag !== true && this.adsFlags.cachedBgmMutedFlag !== true) {
      // unmute all
      if (typeof ig !== "undefined") {
        if (typeof ig.soundHandler !== "undefined") {
        ...
        if (typeof ig.soundHandler.sfxPlayer !== "undefined") {
          if (typeof ig.soundHandler.sfxPlayer.getVolume === "function") {
            if (this.adsFlags.cachedSfxVolume === null) {
              this.adsFlags.cachedSfxVolume = ig.soundHandler.sfxPlayer.getVolume();
            }
          }
        }
      }
        ...
        if (typeof ig.soundHandler.bgmPlayer !== "undefined") {
          if (typeof ig.soundHandler.bgmPlayer.getVolume === "function") {
            if (this.adsFlags.cachedBgmVolume === null) {
              this.adsFlags.cachedBgmVolume = ig.soundHandler.bgmPlayer.getVolume();
            }
          }
        }
      }
      ...
      if (typeof ig.soundHandler !== "undefined") {
        ...
        if (typeof ig.soundHandler.sfxPlayer !== "undefined") {
          if (typeof ig.soundHandler.sfxPlayer.muteFlag !== "undefined") {
            if (this.adsFlags.cachedSfxMutedFlag === null) {
              this.adsFlags.cachedSfxMutedFlag = ig.soundHandler.sfxPlayer.muteFlag;
            }
          }
        }
      ...
      if (typeof ig.soundHandler !== "undefined") {
        ...
        if (typeof ig.soundHandler.bgmPlayer !== "undefined") {
          if (typeof ig.soundHandler.bgmPlayer.muteFlag !== "undefined") {
            if (this.adsFlags.cachedBgmMutedFlag === null) {
              this.adsFlags.cachedBgmMutedFlag = ig.soundHandler.bgmPlayer.muteFlag;
            }
          }
        }
      }

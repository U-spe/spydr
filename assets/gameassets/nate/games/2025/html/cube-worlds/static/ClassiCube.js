...
// include: C:\msys64\tmp\tmpi4nxxczx.js
...
Module['FS_createPath']("/", "maps", true, true);
    ...
    loadPackage({"files": [{"filename": "/maps/Dark_Spawn.lvl", "start": 0, "end": 290714}, {"filename": "/maps/Kingdom_Skyblock.lvl", "start": 290714, "end": 761157}, {"filename": "/maps/Magical_Village.lvl", "start": 761157, "end": 1852004}, {"filename": "/maps/MainMenu.cw", "start": 1852004, "end": 1906178}, {"filename": "/maps/Origin_Spawn.lvl", "start": 1906178, "end": 3609061}, {"filename": "/maps/Survival_Castle.lvl", "start": 3609061, "end": 5297016}, {"filename": "/maps/Survival_Wonderland.lvl", "start": 5297016, "end": 6067634}], "remote_package_size": 6067634});

  })();

// end include: C:\msys64\tmp\tmpi4nxxczx.js
// include: C:\msys64\tmp\tmpwqq6xo3x.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\msys64\tmp\tmpwqq6xo3x.js
// include: C:\msys64\tmp\tmpid3_szuf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\msys64\tmp\tmpid3_szuf.js
...
var ASM_CONSTS = {
  336080: ($0, $1, $2) => { var dptr = $0 >>> 0; var fileSize = $1 >>> 0; var bufPtr = $2 >>> 0; var fd = _interop_FileCreate(dptr, 577 ); if (fd < 0) { console.log('CopyToCCFS: interop_FileCreate failed with code', fd); return; } var written = _interop_FileWrite(fd, bufPtr, fileSize); _interop_FileClose(fd); console.log('CopyToCCFS: Copied', fileSize, 'bytes to CCFS at pointer path:', dptr); }
};
  ...
  registerOrRemoveHandler(eventHandler) {
        ...
        if (eventHandler.callbackfunc) {
          ...
          eventHandler.target.addEventListener(eventHandler.eventTypeString,
                                               ...
                                               { capture: eventHandler.useCapture, passive: false });
